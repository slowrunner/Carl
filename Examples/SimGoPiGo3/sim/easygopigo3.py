...
import math
import json
import sim.easysensors as easysensors
from I2C_mutex import Mutex
from math import pi
import sim.simLog as simLog
import sim.simDataJson as simDataJson

simLog.logger.info("sim.easygopigo3 imported")

try:
    from sim.di_sensors import easy_line_follower, easy_distance_sensor, easy_light_color_sensor, inertial_measurement_unit
...
class EasyGoPiGo3(gopigo3.GoPiGo3):
    ...
    def __init__(self, config_file_path="sim/gpg3_config.json", use_mutex=False):
        """
        ...
        simLog.logger.info("Simulated EasyGoPiGo3 instatiated")

    def load_robot_constants(self, config_file_path="sim/gpg3_config.json"):
        """
        ...
        """
        simLog.logger.info("sim.easygopigo3.load_robot_constants() called")
    ...
    def save_robot_constants(self, config_file_path="sim/gpg3_config.json"):
        """
        ...
        """
        simLog.logger.info("sim.easygopigo3.save_robot_constants() called")
    ...
    def set_robot_constants(self, wheel_diameter, wheel_base_width):
        ...
        """
        simLog.logger.info("sim.easygopigo3.set_robot_constants({},{}) called".format(wheel_diameter,wheel_base_width))
    ...
    def volt(self):
        ...
        voltage = float(simDataJson.getData('vBatt'))
        return voltage
    ...
    def set_speed(self, in_speed):
        ...
        """
        simLog.logger.info("sim.easygopigo3.set_speed({}) called".format(in_speed))
        try:
        ...
        simDataJson.saveData('motor_limit_left',self.speed)
        simDataJson.saveData('motor_limit_right',self.speed)
    ...
    def get_speed(self):
        ...
        """
        simLog.logger.info("sim.easygopigo3.get_speed() called")
    ...
    def reset_speed(self):
        ...
        """
        simLog.logger.info("sim.easygopigo3.reset_speed() called")
    ...
    def stop(self):
        ...
        """
        simLog.logger.info("sim.easygopigo3.stop() called")

        # self.set_motor_dps(self.MOTOR_LEFT + self.MOTOR_RIGHT, 0)
        simDataJson.saveData('motor_dps_left',0)
        simDataJson.saveData('motor_dps_right',0)
    ...
    def forward(self):
        ...
        #                    self.NO_LIMIT_SPEED)
        simLog.logger.info("sim.easygopigo3.forward() called")

        simDataJson.saveData('motor_dps_left',self.NO_LIMIT_SPEED)
        simDataJson.saveData('motor_dps_right',self.NO_LIMIT_SPEED)
    ...
    def drive_cm(self, dist, blocking=True):
        ...
        """
        simLog.logger.info("sim.easygopigo3.drive_cm({}) called".format(dist))
        ...
        if blocking:
            ...
            #     time.sleep(0.1)
            range = simDataJson.getData('rangeSensor_mm')
            simDataJson.saveData('rangeSensor_mm',range - dist_mm)
            time.sleep(2)
    ...
    def drive_degrees(self, degrees, blocking=True):
        ...
        simLog.logger.info("sim.easygopigo3.drive_degrees({}) called".format(degrees))
        StartPositionLeft = self.get_motor_encoder(self.MOTOR_LEFT)
        StartPositionRight = self.get_motor_encoder(self.MOTOR_RIGHT)
    ...
    def backward(self):
        ...
        """
        simLog.logger.info("sim.easygopigo3.backward() called")
    ...
    def right(self):
        ...
        """
        simLog.logger.info("sim.easygopigo3.right() called")
    ...
    def spin_right(self):
        ...
        """
        simLog.logger.info("sim.easygopigo3.spin_right() called")
    ...
    def left(self):
        ...
        """
        simLog.logger.info("sim.easygopigo3.left() called")
    ...
    def spin_left(self):
        ...
        """
        simLog.logger.info("sim.easygopigo3.spin_left() called")
    ...
    def steer(self, left_percent, right_percent):
        ...
        """
        simLog.logger.info("sim.easygopigo3.steer({},{}) called".format(left_percent,right_percent))
    ...
    def orbit(self, degrees, radius_cm=0, blocking=True):
        ...
        """
        simLog.logger.info("sim.easygopigo3.orbit({},{}) called".format(degrees,radius_cm))
    ...
    def target_reached(self, left_target_degrees, right_target_degrees):
        ...
        """
        simLog.logger.info("sim.easygopigo3.target_reached({},{}) called".format(left_target_degrees,right_target_degrees))
    ...
    def reset_encoders(self, blocking=True):
        ...
        """
        simLog.logger.info("sim.easygopigo3.reset_encoders() called")
    ...
    def read_encoders(self):
        ...
        """
        simLog.logger.info("sim.easygopigo3.read_encoders() called")
    ...
    def read_encoders_average(self, units="cm"):
        ...
        :rtype: int
        """
        simLog.logger.info("sim.easygopigo3.read_encoders_average() called")
    ...
    def turn_degrees(self, degrees, blocking=True):
        ...
        """
        simLog.logger.info("sim.easygopigo3.turn_degrees({}) called".format(degrees))
    ...
    def blinker_on(self, id):
        ...
        """
        simLog.logger.info("sim.easygopigo3.blinker_on({}) called".format(id))
    ...
    def blinker_off(self, id):
        ...
        """
        simLog.logger.info("sim.easygopigo3.blinker_off({}) called".format(id))
        if id == 1 or id == "left":
    ...
    def led_on(self, id):
        ...
        """
        simLog.logger.info("sim.easygopigo3.led_on({}) called".format(id))
    ...
    def led_off(self, id):
        ...
        """
        simLog.logger.info("sim.easygopigo3.led_off({}) called".format(id))
    ...
    def set_left_eye_color(self, color):
        ...
        """
        simLog.logger.info("sim.easygopigo3.set_left_eye_color({}) called".format(color))
    ...
    def set_right_eye_color(self, color):
        ...
        """
        simLog.logger.info("sim.easygopigo3.set_right_eye_color({}) called".format(color))
    ...
    def set_eye_color(self, color):
        ...
        """
        simLog.logger.info("sim.easygopigo3.set_eye_color({}) called".format(color))
    ...
    def open_left_eye(self):
        ...
        """
        simLog.logger.info("sim.easygopigo3.open_left_eye() called")
    ...
    def open_right_eye(self):
        ...
        """
        simLog.logger.info("sim.easygopigo3.open_right_eye() called")
    ...
    def open_eyes(self):
        ...
        """
        simLog.logger.info("sim.easygopigo3.open_eyes() called")
    ...
    def close_left_eye(self):
        ...
        """
        simLog.logger.info("sim.easygopigo3.close_left_eye() called")
    ...
    def close_right_eye(self):
        ...
        """
        simLog.logger.info("sim.easygopigo3.close_right_eye() called")
    ...
    def close_eyes(self):
        ...
        """
        simLog.logger.info("sim.easygopigo3.close_eyes() called")
    ...
    def init_servo(self, port = "SERVO1"):
        ...
        """
        simLog.logger.info("sim.easygopigo3.init_servo(port={}) called".format(port))
    ...
    def init_distance_sensor(self, port = "I2C"):
        ...
        """
        simLog.logger.info("sim.easygopigo3.init_distance_sensor(port={}) called".format(port))
    ...
    def init_imu_sensor(self, port = "I2C"):
        ...
        """
        simLog.logger.info("sim.easygopigo3.init_imu_sensor(port={}) called".format(port))
