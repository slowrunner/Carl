...
speech = LiveSpeech(audio_device='hw:1,0',sampling_rate=16000,verbose=True,lm=False,keyphrase='forward',kws_threshold='le-20')
# speech = LiveSpeech(audio_device='default',sampling_rate=16000,verbose=True,lm=False,keyphrase='forward',kws_threshold='le-20')
