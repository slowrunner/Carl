...
#
# Python drivers for the HiLetgo MPU-9250/6500
# 9-Axis 9 DOF 16 Bit Gyro Accel Mag IMU sensor
# connected via (Hardware) I2C

"""

HiLetgo MPU-9250, which is a multi-chip module (MCM) consisting of two dies integrated into a single QFN package.
Combining a 3-Axis gyroscope, a 3-Axis accelerometer, the AK8963 3-Axis magnetometer, a Digital Motion Processor (DMP),
...
# I2C addresses
DEV_ADDRESS                 = 0x68  # 9255 Gyro/Accel
MAG_ADDRESS                 = 0x0C  # Mag
...
# Power management 2  Register 107 (0x01) 
POWER_MODE_SLEEP            = 0x01  # Off,   Off,    Off, Off
POWER_MODE_STANDBY          = 0x02  # Drive, Off,    Off, Off
POWER_MODE_LOW_PWR_ACCEL    = 0x03  # Off,   Cycled, Off, On|Off
POWER_MODE_LOW_NOICE_ACCEL  = 0x04  # Off,   On,     Off, On|Off
POWER_MODE_GYRO             = 0x05  # On,    Off,    Off, On|Off
POWER_MODE_MAG              = 0x06  # Off,   Off,    On,  On|Off
POWER_MODE_ACCEL_GYRO       = 0x07  # On,    On,     Off, On|Off
POWER_MODE_ACCEL_MAG        = 0x08  # Off,   On,     On,  On|Off
POWER_MODE_9AXIS            = 0x09
...
class BNO055(object):
    ...
    def __init__(self, bus = "RPI_1HW", address = DEV_ADDRESS, mode = OPERATION_MODE_NDOF, units = 0):
