...
def main():
	...
	# Calibrate the mag or provide values that have been verified with the visualizer
        ...
        # uncomment following line to run mag calibration
	mpu.calibrateMagGuide()   # ALAN: uncommented

	# Original coded values from developer
	# bias = [145, 145, -155]
	# scale = [1.10, 1.05, 1.05]

	# values for data3.txt "Calibration complete:"
	magXbias = 165.425
	magYbias = -334.633
	magZbias = -241.794
	...
	bias  = [magXbias,  magYbias,  magZbias ]
