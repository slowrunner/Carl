...
# File: carl_porcupine_mic.py

# Usage: ./carl_porcupine_mic.py

# Demonstrates PicoVoice Porcupine Wake Word Engine
# (running on my GoPiGo3 robot Carl using espeakng)
# to respond with "Yes. I heard you" when "porcupine" is said
...
# enable espeak next generation text-to-speech engine
import espeakng
...
class PorcupineDemo(Thread):
    ...
    def __init__(
        ...
        # Initialize an espeakng Text-to-speech speaker object
        self.tts = espeakng.Speaker()
        ...
        try:
            ...
            while True:
                ...
                if result >= 0:
                    ...
                    # Have Carl respond with espeakng Text-To-Speech
                    self.tts.say("Yes.  I heard you.")
...
def main():
    ...
    # add default porcupine keyword as wake word
    parser.add_argument(
        '--keywords',
        nargs='+',
        default=['porcupine'],
    ...
    # set default for Carl's mic to device 1
    ...
    if args.show_audio_devices:
        ...
        if args.keyword_paths is None:
            ...
            print("args.keywords: {}".format(args.keywords))
