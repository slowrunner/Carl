...
#        self.lm = 'language_model.lm'
        ...
        # print("get_model_path() returns:", get_model_path() )

        self.MODELDIR = "/usr/local/lib/python3.5/dist-packages/pocketsphinx/model"
        self.DATADIR = "/usr/local/lib/python3.5/dist-packages/pocketsphinx/data"

        self.hmm = path.join(self.MODELDIR, 'en-us')
        self.lm  = path.join(self.MODELDIR, 'en-us.lm.bin')
        self.dic = path.join(self.MODELDIR, 'cmudict-en-us.dict')
