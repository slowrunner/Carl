...
Purpose: Creates and Runs an instance of kbd_easygopigo3.GoPiGo3WithKeyboard
         which gives command window keyboard control of the GoPiGo3
         (This version adds servo control keys left, center, right))
...
def Main():
    ...
    with Input(keynames = "curtsies", sigint_event = True) as input_generator:
        while True:
            ...
            if key is not None:
                result = gopigo3kbd.executeKeyboardJob(key)
            ...
            # for moving (the robot around) are released
                ...
                gopigo3kbd.executeKeyboardJob("x")
