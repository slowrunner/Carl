...
"""
# FILE:  backward_test.py

# PURPOSE:  Test VirtualBumper for GoPiGo3 backward()
...
def main():
    ...
    logging.info("=== VIRTUAL BUMPERS BACKWARD TEST ===")
    ...
    egpg.backward()
    logging.info("*** backward({}) test, checking bumpers {} times per second ***".format(drive_time, BUMPER_CHECK_RATE))
