...
#
# gopigo_newyear.py    Wish Happy New Year
#      Watch for impending new year,
#      Count Down from 10 seconds before new year
#      Wish "Happy New Year"
#      otherwise print status every 5 seconds
#      ( will shutdown if battery voltage falls below 8.1v )
#
# USAGE:
# ./gopigo_newyear.py         (start on December 31st of any year)
#
#  python3 gopigo_newyear.py
#
# ./newyear.py -t or --test   targets 2nd future minute as start of new year
