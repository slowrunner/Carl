...
# FILE: treaded_SW_dist_sensors.py

# PURPOSE: Test with two threads reading the distance sensor, both SW I2C
...
def main():
    ...
    t1 = CheckDistSensor(name="SW_i2c_1",port="RPI_1SW")
    t2 = CheckDistSensor(name="SW_i2c_2",port="RPI_1SW")
    t1.start()
    t2.start()
